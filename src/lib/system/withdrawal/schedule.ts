import type { RuntimeWithdrawalSchedule } from "../runtime/types";
...
function getOccurrenceAt(
  schedule: Pick<RuntimeWithdrawalSchedule, "dayOfMonth">,
...
const runtimeWithdrawalSchedule = {
  timing: {
    getNextOccurrenceAt,
    getOccurrenceAt,
    isDue,
...
export default runtimeWithdrawalSchedule;
