export interface RuntimeDailyPerformanceTrade {
  entryTime: number;
  exitTime?: number;
  netPnlPct?: number;
...
export interface RuntimeDailyPerformanceBalanceSnapshot {
  day: string;
  timestamp: number;
  total: number;
}

export interface RuntimeDailyTradeMetrics {
...
export interface RuntimeDailyBalanceMetrics {
...
export interface RuntimeDailyPerformanceReport {
  balance: RuntimeDailyBalanceMetrics;
  day: string;
  dayEndMs: number;
  dayStartMs: number;
  trades: RuntimeDailyTradeMetrics;
}
...
function summarizeTradesByUtcDay(
  history: RuntimeDailyPerformanceTrade[],
): Map<string, RuntimeDailyTradeMetrics> {
  const byDay = new Map<string, RuntimeDailyTradeMetrics>();
...
function summarizeBalance(params: {
  balanceSnapshots: RuntimeDailyPerformanceBalanceSnapshot[];
  day: string;
...
export default runtimeDailyPerformance;
export { runtimeDailyPerformance };
