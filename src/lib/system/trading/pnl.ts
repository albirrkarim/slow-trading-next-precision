...
/** Computes the fee-aware net gain ratio of a position at the given price. */
...
/** Computes fee-aware closed metrics for a position at the given price. */
...
const pnl = {
  computeNetGainRatio: computePositionNetGainRatio,
  computeClosedMetrics: computeClosedPositionMetrics,
  applyNetUsdtExtrema: applyPositionNetUsdtExtrema,
} as const;
