...
import PostAverageRescueExitSettings from "@/components/LiveDashboard/Navbar/Settings/Trading/PostAverageRescueExitSettings";
import PostAverageStopLossSettings from "@/components/LiveDashboard/Navbar/Settings/Trading/PostAverageStopLossSettings";
import {
    Box,
    Checkbox,
    Divider,
